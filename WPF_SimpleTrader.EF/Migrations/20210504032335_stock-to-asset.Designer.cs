...
namespace WPF_SimpleTrader.EF.Migrations
{
    ...
    [Migration("20210504032335_stock-to-asset")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WPF_SimpleTrader.Domain.Models.AssetTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WPF_SimpleTrader.Domain.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WPF_SimpleTrader.Domain.Models.Account", b =>
                {
                    b.HasOne("WPF_SimpleTrader.Domain.Models.User", "AccountHolder")
                        .WithMany()
            ...
            modelBuilder.Entity("WPF_SimpleTrader.Domain.Models.AssetTransaction", b =>
                {
                    b.HasOne("WPF_SimpleTrader.Domain.Models.Account", "Account")
